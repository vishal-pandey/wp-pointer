...
<?php get_header(); ?>
    <div class="site-blocks-cover overlay" style="background-image: url(<?php echo get_template_directory_uri()."/"; ?>images/tour-and-travels.jpg); box-shadow:inset 0 0 0 2000px rgba(0,0,0,0.4);" data-aos="fade" id="home-section">
      <div class="container">
        <div class="row align-items-center justify-content-center">

          
              <div class="col-md-6 mt-lg-5 text-center">
                <h1>We Are Aflah Groups</h1>
                <p class="mb-5">We deal in : Domestic money remittance, Mobile recharge, Utility bill payments through handy digital devices - Personal computer and Android phones.We also provide services through API and SMS Long codes.</p>
                <div>
          ...
          <div class="col-md-6 col-lg-3 mb-4">
            <div class="team-member">
              <figure>
                ...
                <img src="<?php echo get_template_directory_uri()."/"; ?>images/person_5.jpg" alt="Image" class="img-fluid">
              </figure>
              <div class="p-3">
          ...
          <div class="col-md-6 col-lg-3 mb-4">
            <div class="team-member">
              <figure>
                ...
                <img src="<?php echo get_template_directory_uri()."/"; ?>images/person_6.jpg" alt="Image" class="img-fluid">
              </figure>
              <div class="p-3">
                <h3>Dave Simpson</h3>
                <span class="position">Product Manager</span>
          ...
          <div class="col-md-6 col-lg-3 mb-4">
            <div class="team-member">
              <figure>
                ...
                <img src="<?php echo get_template_directory_uri()."/"; ?>images/person_7.jpg" alt="Image" class="img-fluid">
              </figure>
              <div class="p-3">
                <h3>Ben Thompson</h3>
                <span class="position">Product Manager</span>
          ...
          <div class="col-md-6 col-lg-3 mb-4">
            <div class="team-member">
              <figure>
                ...
                <img src="<?php echo get_template_directory_uri()."/"; ?>images/person_8.jpg" alt="Image" class="img-fluid">
              </figure>
              <div class="p-3">
                <h3>Kyla Stewart</h3>
                <span class="position">Product Manager</span>
          ...
          <div class="col-md-6 col-lg-3 mb-4">
            <div class="team-member">
              <figure>
                ...
                <img src="<?php echo get_template_directory_uri()."/"; ?>images/person_4.jpg" alt="Image" class="img-fluid">
              </figure>
              <div class="p-3">
                <h3>Chris Stewart</h3>
                <span class="position">Product Manager</span>
        ...
        <div class="row">
          <div class="col-lg-6">
            ...
            <div class="owl-carousel slide-one-item-alt">
              <img src="<?php echo get_template_directory_uri()."/"; ?>images/slide_1.jpg" alt="Image" class="img-fluid">
              <img src="<?php echo get_template_directory_uri()."/"; ?>images/slide_2.jpg" alt="Image" class="img-fluid">
              <img src="<?php echo get_template_directory_uri()."/"; ?>images/slide_3.jpg" alt="Image" class="img-fluid">
              <img src="<?php echo get_template_directory_uri()."/"; ?>images/slide_4.jpg" alt="Image" class="img-fluid">
            </div>
          ...
          <div class="col-lg-5 ml-auto">
            ...
            <h2 class="section-title mb-3">We Are The Best Travel Agency</h2>
      ...
      <div class="container">
        <div class="row mb-5">
          <div class="col-12">
            ...
            <p class="lead">Trust and transparency are our mantras to be associated with our partners, distributors, retailers and clients . We are equipped with essential IT support and 24x7 technical assistance.</p>
          </div>
        </div>
        <div class="row">
          <div class="col-md-6 col-lg-4">
            <div class=" box-with-humber">
              <h2 class="text-black"><span class="text-primary">01.</span>Start</h2>
          ...
          <div class="col-md-6 col-lg-4">
            <div class=" box-with-humber">
              <h2 class="text-black"><span class="text-primary">03.</span>Document Collection</h2>
              <p class="mb-4">Lorem ipsum dolor sit amet consectetur adipisicing elit. Et praesentium eos nulla qui commodi consectetur beatae fugiat. Veniam iste rerum perferendis.</p>
          ...
          <div class="col-md-6 col-lg-4">
            <div class=" box-with-humber">
              <h2 class="text-black"><span class="text-primary">04.</span>Document Verification</h2>
              <p class="mb-4">Lorem ipsum dolor sit amet consectetur adipisicing elit. Et praesentium eos nulla qui commodi consectetur beatae fugiat. Veniam iste rerum perferendis.</p>
          ...
          <div class="col-md-6 col-lg-4">
            <div class=" box-with-humber">
              <h2 class="text-black"><span class="text-primary">05.</span>Account Creation</h2>
              <p class="mb-4">Lorem ipsum dolor sit amet consectetur adipisicing elit. Et praesentium eos nulla qui commodi consectetur beatae fugiat. Veniam iste rerum perferendis.</p>
          ...
          <div class="col-md-6 col-lg-4">
            <div class=" box-with-humber">
              <h2 class="text-black"><span class="text-primary">06.</span>Go Live</h2>
              <p class="mb-4">Lorem ipsum dolor sit amet consectetur adipisicing elit. Et praesentium eos nulla qui commodi consectetur beatae fugiat. Veniam iste rerum perferendis.</p>
      ...
      <div class="slide-one-item home-slider owl-carousel">
          <div>
            <div class="testimonial">
              ...
              <figure class="mb-4 d-flex align-items-center justify-content-center">
                <div><img src="<?php echo get_template_directory_uri()."/"; ?>images/person_3.jpg" alt="Image" class="w-50 img-fluid mb-3"></div>
                <p>John Smith</p>
              </figure>
            </div>
          </div>
          <div>
            <div class="testimonial">
              ...
              <figure class="mb-4 d-flex align-items-center justify-content-center">
                <div><img src="<?php echo get_template_directory_uri()."/"; ?>images/person_2.jpg" alt="Image" class="w-50 img-fluid mb-3"></div>
          ...
          <div>
            <div class="testimonial">
              ...
              <figure class="mb-4 d-flex align-items-center justify-content-center">
                <div><img src="<?php echo get_template_directory_uri()."/"; ?>images/person_4.jpg" alt="Image" class="w-50 img-fluid mb-3"></div>
                <p>Robert Spears</p>
              </figure>
    ...
    <section class="site-section" id="tour-section">
      <div class="container">
        <div class="row mb-5">
          ...
          <div class="col-md-6 order-md-1" data-aos="fade">
            ...
            <div class="row">
              ...
              <div class="col-12 mb-4">
                <h2 class="section-title mb-3">Travel Agency It's Best</h2>
              </div>
          ...
          <div class="col-md-12 order-md-3" data-aos="fade">
            <div class="row">
    ...
    <section class="site-section display-none" id="blog-section">
      <div class="container">
        <div class="row mb-5">
          <div class="col-12 text-center">
        ...
        <div class="row">
          <div class="col-md-6 col-lg-4 mb-4 mb-lg-4">
            <div class="h-entry">
              <a href="single.html"><img src="<?php echo get_template_directory_uri()."/"; ?>images/img_1.jpg" alt="Image" class="img-fluid"></a>
          ...
          <div class="col-md-6 col-lg-4 mb-4 mb-lg-4">
            <div class="h-entry">
              <a href="single.html"><img src="<?php echo get_template_directory_uri()."/"; ?>images/img_2.jpg" alt="Image" class="img-fluid"></a>
              <h2 class="font-size-regular"><a href="single.html">Lorem ipsum dolor sit amet, consectetur adipisicing elit.</a></h2>
    ...
    <section class="site-section bg-light" id="contact-section">
      <div class="container">
        <div class="row mb-5">
          <div class="col-12 text-center">
            <h3 class="section-sub-title">We are always reachable</h3>
            <h2 class="section-title mb-3">Happy to Connect</h2>
          </div>
        </div>
        <div class="row">
          ...
          <div class="col-md-5">
            ...
            <div class="p-4 mb-3 bg-white">
              ...
              <p class="mb-4">C-119, Street No-9 Village Wazirabad Delhi - 110084</p>

              <p class="mb-0 font-weight-bold">Phone</p>
              <p class="mb-4"><a href="#">+91 93 55 63 5175</a></p>

              <p class="mb-0 font-weight-bold">Email Address</p>
              <p class="mb-0"><a href="#">info@aflahgroups.com</a></p>
